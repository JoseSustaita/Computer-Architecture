...
class CPU:
    ...
    def load(self):
        ...
        # Loads program from our examples folder and ignores everything in it except the binary code
        if len(sys.argv) != 2:
            print("To test try python3 ls8.py examples/*Program name*")
            sys.exit(1)
        try:
